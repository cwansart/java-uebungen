public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("args[0] ist unültig");
            operand1 = 0;
        }
        ...
        try {
            ...
            System.out.println("args[1] ist unültig");
            operand2 = 0;
        }

        int summe = addiere(operand1, operand2);
        System.out.println(operand1 + " + " + operand2 + " = " + summe);
    }
